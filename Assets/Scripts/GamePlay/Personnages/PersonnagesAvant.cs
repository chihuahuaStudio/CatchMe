...
namespace GamePlay.Personnages
{
    ...
    public class PersonnagesAvant : MonoBehaviour, IDeplacement, ICalculeDeplacement, ISetDeplacement
    {
        ...
        void Update()
        {
            ...
            // SetArretPersonnages(nombreDeplacementEffectue, nombreMaxDeplacement);
            
            if (Time.time >= delaiProchainDeplacement && nombreDeplacementEffectue < nombreMaxDeplacement)
            {
                SetDepartPersonnage();
            }
        }
